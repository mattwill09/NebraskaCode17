...
namespace InAppPurchaseTest
{
	public partial class SettingsController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			// Wireup switch
			ShuffleSwitch.On = InAppPurchaseHandler.PurchaseManager.ShuffleProductsOnPersistence;
			ShuffleSwitch.ValueChanged += (sender, e) => {
				// Read new value
				InAppPurchaseHandler.PurchaseManager.ShuffleProductsOnPersistence = ShuffleSwitch.On;
			};
			...
			AddButton.TouchUpInside += (sender, e) => {
				...
				if (AddProduct.Text!="") {
					InAppPurchaseHandler.PurchaseManager.QueryInventory(AddProduct.Text);
			...
			if (!InAppPurchaseHandler.PurchaseManager.SimulateiTunesAppStore) {
			...
			ResetButton.TouchUpInside += (caller, e) => {
				...
				alert.Clicked += (sender, buttonArgs) => {
					...
					if (buttonArgs.ButtonIndex==1) {
						...
						InAppPurchaseHandler.PurchaseManager.PurgeProducts();
						...
						InAppPurchaseHandler.PurchaseManager.QueryInventory (new string[] { 
